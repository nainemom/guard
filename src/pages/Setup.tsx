      ...
      <Body className="flex flex-col">
        <div className="flex-grow p-3 flex flex-col items-stretch justify-center gap-3 text-base w-full max-w-xs mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-body-subtitle">
              Setup your Account to use Guard App!
            </p>
          </div>
          <Button
            theme="primary"
            ...
            size="lg"
            ariaLabel="Generate new Account"
          >
            <Icon name="magic_button" className="w-5 h-5" />
            Generate new Account!
          </Button>
          <div className="text-center border-b my-3 border-body-lighter leading-[2px]">
            or
          </div>
          <Button
            theme="default"
          ...
          <Button
            theme="default"
            onClick={() => setPersonalKeysDialog(true)}
            size="lg"
            ariaLabel="Manually Enter Keys"
          >
        ...
        <Dialog isOpen={personalKeysDialog}>
          {personalKeysDialog && (
