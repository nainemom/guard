...
import type { CryptographyPublicKey } from '@/services/cryptography';
...
export default function Avatar({ publicKey, className }: AvatarProps) {
  ...
  useEffect(() => {
    ...
    const unum = (min: number, max: number, salt: string) =>
      str2num(publicKey + salt, min, max);
    setStyle(['head-group'], {
        ...
        >
          ...
          <g id="eye-left">
            <rect
              ...
              ry="19"
            />
            <circle fill="#f9f9f9" id="eye-left-center" cx="79" cy="54" r="5" />
          </g>
          <g id="mouth">
            <rect
              fill="#4d4d4d"
